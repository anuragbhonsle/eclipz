...
const Index = () => {
  ...
  useEffect(() => {
    const text = "Speak your mind. No one will know.";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 pt-20 pb-20 min-h-[98vh] relative">
        <div className="max-w-3xl w-full text-center space-y-8 z-10">
          ...
          <div className="typing-container">
            <p
              ref={typingTextRef}
              className="text-xl md:text-2xl text-muted-foreground pb-2"
            ></p>
          </div>
      ...
      <section
        ref={howItWorksRef}
        className="flex-1 flex flex-col items-center justify-center px-4 pt-20 min-h-[95vh] bg-secondary/30 mb-20"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
            <div className="card-glass flex flex-col items-center text-center p-8 h-full transition-transform hover:scale-105">
              ...
              <p className="text-muted-foreground">
                Sign up to receive messages and get your unique @username
              </p>
            </div>
            ...
            <div className="card-glass flex flex-col items-center text-center p-8 h-full transition-transform hover:scale-105">
              ...
              <p className="text-muted-foreground">
                Tell friends your @username so they can message you
              </p>
            </div>
            ...
            <div className="card-glass flex flex-col items-center text-center p-8 h-full transition-transform hover:scale-105">
              ...
              <p className="text-muted-foreground">
                Check your private inbox for anonymous messages from anyone
              </p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 text-center">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-muted-foreground">
            Help shape Eclipz — join the early community today.
          </p>
